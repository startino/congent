<script lang="ts">
	...
	let { events, profile } = data;
</script>

<main class="flex h-full w-full flex-col items-center justify-center">
	<div class="items-between flex h-screen w-full max-w-2xl flex-col justify-between">
		<ActionButtons status="profile" profileLink={`/chat/${data.profile.id}/profile`} />
		{#await events}
